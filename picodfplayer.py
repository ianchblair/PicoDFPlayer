...
# This version Ian Blair 2024
# Modified from PicoDFplayer to allow for asyncio delay
# Begin method added, including options for noAck, doReset, and useAsyncio
#
...
class DFPlayer():
    ...
    def begin(self, isAck, doReset, useAsyncio):
        _isAck = isAck
        _doReset = doReset
